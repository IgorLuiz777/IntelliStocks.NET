...
namespace IntelliStocks.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        public EnderecosController(OracleDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Rua,Numero,Cidade")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Rua,Numero,Cidade")] Endereco endereco)
        {
